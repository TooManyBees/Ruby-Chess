...
#
#       begin
#         self.board.legal_move_check(piece, king_loc)
#         self.board.legal_destination_check(piece, king_loc, opponent)
#         self.board.obstruction_check(piece, king_loc)
...
#         raise IOError.new("Move blocked at #{spot}.") unless self.board[spot].empty?
#       end
#     else # is a diagonal
#       path = []
